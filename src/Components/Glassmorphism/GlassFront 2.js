...
const GlassCard = () => {
  ...
  return (
    ...
    //     <div className="debit">DebitCard</div>
    //   </div>
    // </div>

    // <div style={cardStyles}>
    //   <div className='front GlassCardBlur'>
    ...
    //         neque justo. Fusce ultrices dictum ligula quis fringilla. Nunc
    //         commodo libero non lacinia eleifend. Duis lacus dui, elementum vel
    //         sapien ut, suscipit porta tortor. Integer volutpat sit amet turpis
    //         at fringilla. Vestibulum odio lectus, vestibulum eu nisi non,
    //         commodo eleifend odio. Ut dolor mi, ornare sed arcu at, porta
    //         vehicula massa. Praesent pharetra odio vitae dolor placerat tempus.
    //         Maecenas eget orci nunc.
    //       </div>
    //     </div>
    //     <div
    //       className='before'
    ...
    <div className='card'>
      <div className='face front'>
        ...
        <h5 className='cardHolder'>Mohammed Smith</h5>
      </div>
      {/* <div className='face back'>
        ...
        <div className='ccvtext'>
          ...
          <p className='text'>
            ...
            neque justo. Fusce ultrices dictum ligula quis fringilla. Nunc //
            commodo libero non lacinia eleifend. Duis lacus dui, elementum vel
            // sapien ut, suscipit porta tortor. Integer volutpat sit amet
            turpis // at fringilla. Vestibulum odio lectus, vestibulum eu nisi
            non, // commodo eleifend odio. Ut dolor mi, ornare sed arcu at,
            porta // vehicula massa. Praesent pharetra odio vitae dolor placerat
            tempus. // Maecenas eget orci nunc.
          </p>
        </div>
      </div> */}
    </div>
